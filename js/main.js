...
function getServiceDetails() {
    ...
    const services = {
        ...
        'assignments': {
            ...
            subtitle: 'إنجاز جميع الواجبات والأنشطة الدراسية',
            description: 'نساعدك في إنجاز جميع الواجبات والأنشطة الدراسية بدقة عالية وفي الوقت المحدد. نقدم حلول شاملة ومفصلة لجميع المواد والمستويات الدراسية.',
            icon: '📝'
        },
        'exam-solving': {
            title: 'حل الامتحانات',
            subtitle: 'حل جميع أنواع الامتحانات والاختبارات',
            description: 'نقدم خدمات حل الامتحانات والاختبارات في جميع المواد والتخصصات. نحل الامتحانات بدقة عالية ونضمن لك النجاح والحصول على أعلى الدرجات.',
            icon: '📋'
        },
        'reports-research': {
            title: 'التقارير والبحوث',
            subtitle: 'تقارير وبحوث أكاديمية احترافية',
            description: 'نكتب لك التقارير والبحوث الأكاديمية بأعلى مستويات الجودة والدقة. نقدم محتوى أصلي ومفصل مع الاستشهادات والمراجع العلمية المناسبة.',
            icon: '📄'
        },
        'cv-creation': {
            title: 'إنشاء السيرة الذاتية',
            subtitle: 'سير ذاتية احترافية وجذابة',
            description: 'نصمم لك سيرة ذاتية احترافية وجذابة تساعدك في الحصول على فرص العمل المرغوبة. نركز على إبراز نقاط القوة وجعل سيرتك مميزة عن غيرها.',
            icon: '👔'
        },
        'website-development': {
            title: 'تطوير المواقع',
            subtitle: 'مواقع إلكترونية احترافية ومتجاوبة',
            description: 'نطور لك مواقع إلكترونية احترافية ومتجاوبة مع جميع الأجهزة. نقدم تصاميم عصرية ووظائف متقدمة تضمن تجربة مستخدم ممتازة.',
            icon: '💻'
        },
        'data-office': {
            title: 'إدخال البيانات ومهام أوفيس',
            subtitle: 'خدمات إدخال البيانات ومعالجة الملفات',
            description: 'نقدم خدمات إدخال البيانات بدقة عالية ومعالجة جميع مهام Microsoft Office (Word, Excel, PowerPoint). نساعدك في تنظيم ومعالجة بياناتك بطريقة احترافية.',
            icon: '📊'
        }
    };
